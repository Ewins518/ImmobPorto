...
class PostsDataTable extends DataTable
{
    ...
    {
        $columns = [
            Column::make('title')->title(__('Titre'))
        ];
        
        if(auth()->user()->role === 'admin') {
            array_push($columns, 
                Column::make('user.name')->title(__('Auteur'))
            );
        }
        array_push($columns,
            Column::computed('categories')->title(__('Categorie')),
            Column::computed('comments_count')->title(__('Nbre Souscription'))->addClass('text-center align-middle'),
