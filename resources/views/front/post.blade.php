  ...
  @if(Auth::check())
    ...
    <div class="row comment-respond">
        ...
        <div id="respond" class="column">
            ...
            <h3>@lang('Souscrire en laissant un message')
            ...
            <form id="messageForm" method="post" action="{{ route('posts.comments.store', $post->id) }}" autocomplete="off">
                ...
                <p id="forSubmit" class="text-center">
                    <input name="submit" id="submit" class="btn btn--primary btn-wide btn--large h-full-width" value="@lang('Souscription')" type="submit">
                </p>
        ...
        (() => {
            ...
            const addComment = async e => {
                ...
                if (response.ok) {
                    ...
                    if(data == 'ok') {
                       // showComments();
                        showAlert('success', '@lang('Votre souscription a été enrégistrée ')');
                    } else {
                        showAlert('info', "@lang('Merci pour votre souscription')");
                    }
                } else {
